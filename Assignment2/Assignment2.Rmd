...
### Approach
<p style="color:red;">
Say something about the idea behind random forests: many trees, bootstrap sample, splitting on subset of columns to reduce correlation between the trees. Als say something about the way we did our cross validation. </p>
