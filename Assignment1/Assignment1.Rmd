...
We did not include the last numerical variable *peak rank* here, because we are not sure how to interpret its summary statistics. For example, we already know that the minimal and maximal observation of this variable will be 1 and 200 respectively. In addition, what does a mean of 66 actually imply? Maybe that a top 200 song peaks at rank 66 on average.  
We think of the variable *peak rank* as the dependent variable in an analysis model for data, as the variable we want to predict. We will use it often in creating exploratory plots.
